from definetti.inclusion.momentuminclusion import using_momentum
from definetti.inclusion.numpyinclusion import using_numpy
from definetti.inclusion.timemachinesinclusion import using_timemachines


if using_momentum and using_timemachines and using_numpy:

    from definetti.ongoingcategoricallottery import OngoingCategoricalLottery
    from definetti.conventions import horizon_str_to_k_and_tau
